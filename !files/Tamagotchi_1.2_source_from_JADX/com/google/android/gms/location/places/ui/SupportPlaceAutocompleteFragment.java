...
public class SupportPlaceAutocompleteFragment extends Fragment {
    ...
    class C04561 implements OnClickListener {
        ...
        C04561(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
    ...
    class C04572 implements OnClickListener {
        ...
        C04572(SupportPlaceAutocompleteFragment supportPlaceAutocompleteFragment) {
            this.zzaRo = supportPlaceAutocompleteFragment;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(C0196R.layout.place_autocomplete_fragment, container, false);
        this.zzaRh = inflate.findViewById(C0196R.id.place_autocomplete_search_button);
        this.zzaRi = inflate.findViewById(C0196R.id.place_autocomplete_clear_button);
        this.zzaRj = (EditText) inflate.findViewById(C0196R.id.place_autocomplete_search_input);
        OnClickListener c04561 = new C04561(this);
        this.zzaRh.setOnClickListener(c04561);
        this.zzaRj.setOnClickListener(c04561);
        this.zzaRi.setOnClickListener(new C04572(this));
        zzzF();
        return inflate;
    }
