...
public final class Nearby {
    public static final Api<NoOptions> CONNECTIONS_API = new Api("Nearby.CONNECTIONS_API", zzql.zzUJ, zzql.zzUI);
    ...
    public static final Api<NoOptions> zzbaL = new Api("Nearby.SHARING_API", zzh.zzUJ, zzh.zzUI);
    public static final zzd zzbaM = new zzh();
    public static final zze zzbaN = new zzi();
    public static final Api<NoOptions> zzbaO = new Api("Nearby.BOOTSTRAP_API", zzqd.zzUJ, zzqd.zzUI);
