...
public class zzi extends zzd {
    private final zza zzQH = new zza(this);
    private zzac zzQI;
...
*/
        ...
        public void onServiceDisconnected(final ComponentName name) {
            ...
            this.zzQL.zzjo().zzf(new Runnable(this) {
                final /* synthetic */ zza zzQP;

                public void run() {
                    this.zzQP.zzQL.onServiceDisconnected(name);
                }
            });
        }
    ...
    protected zzi(zzf com_google_android_gms_analytics_internal_zzf) {
        ...
        this.zzQJ = new zzt(this, com_google_android_gms_analytics_internal_zzf) {
            final /* synthetic */ zzi zzQL;
