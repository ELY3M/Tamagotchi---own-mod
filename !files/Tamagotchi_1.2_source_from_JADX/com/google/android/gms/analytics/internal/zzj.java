...
class zzj extends zzd implements Closeable {
    ...
    class zza extends SQLiteOpenHelper {
        ...
        private void zzb(SQLiteDatabase sQLiteDatabase) {
            int i = 0;
            Set zzb = zzb(sQLiteDatabase, TMXConstants.TAG_PROPERTIES);
        ...
        public void onOpen(SQLiteDatabase database) {
            ...
            if (zza(database, TMXConstants.TAG_PROPERTIES)) {
                zzb(database);
            } else {
    ...
    public void zza(long j, String str) {
        ...
        zzjv();
        zzjk();
        int delete = getWritableDatabase().delete(TMXConstants.TAG_PROPERTIES, "app_uid=? AND cid<>?", new String[]{String.valueOf(j), str});
        if (delete > 0) {
    ...
    public void zzb(zzh com_google_android_gms_analytics_internal_zzh) {
        ...
        try {
            if (writableDatabase.insertWithOnConflict(TMXConstants.TAG_PROPERTIES, null, contentValues, 5) == -1) {
    ...
    public void zzjM() {
        zzjk();
        zzjv();
        getWritableDatabase().delete(TMXConstants.TAG_PROPERTIES, null, null);
    }
