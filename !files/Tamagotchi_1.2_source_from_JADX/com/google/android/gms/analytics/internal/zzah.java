...
class zzah extends zzd {
    ...
    private final String zzzN = zza("GoogleAnalytics", zze.VERSION, VERSION.RELEASE, zzam.zza(Locale.getDefault()), Build.MODEL, Build.ID);
    ...
    private int zzb(URL url, byte[] bArr) {
        ...
        try {
            ...
            try {
                zzc.setDoOutput(true);
                zzc.addRequestProperty("Content-Encoding", TMXConstants.TAG_DATA_ATTRIBUTE_COMPRESSION_VALUE_GZIP);
