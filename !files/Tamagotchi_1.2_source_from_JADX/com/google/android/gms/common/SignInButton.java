...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    private void zza(Context context, AttributeSet attributeSet) {
        int i = 0;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0196R.styleable.SignInButton, 0, 0);
        try {
            this.mSize = obtainStyledAttributes.getInt(C0196R.styleable.SignInButton_buttonSize, 0);
            this.mColor = obtainStyledAttributes.getInt(C0196R.styleable.SignInButton_colorScheme, 2);
            String string = obtainStyledAttributes.getString(C0196R.styleable.SignInButton_scopeUris);
            if (string == null) {
                this.zzafT = null;
            } else {
