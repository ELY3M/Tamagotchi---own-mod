...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C02061 implements Runnable {
        ...
        C02061(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C02072 implements Runnable {
        ...
        C02072(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02094 implements Runnable {
        ...
        C02094(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02105 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02105(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02116 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02116(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02127 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02127(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    private void zzfa() {
        Throwable e;
        zzin.m33v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzfb() {
        if (zzfe() && this.zzDR.getCurrentPosition() > 0 && this.zzDQ != 3) {
            zzin.m33v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzDR.start();
    ...
    private void zzfd() {
        zzin.m33v("AdMediaPlayerView abandon audio focus");
        AudioManager zzfk = zzfk();
        if (zzfk != null && this.zzEa) {
    ...
    private void zzfh() {
        zzin.m33v("AdMediaPlayerView audio focus gained");
        this.zzEa = true;
        zzfj();
    }

    private void zzfi() {
        zzin.m33v("AdMediaPlayerView audio focus lost");
        this.zzEa = false;
        zzfj();
    }
    ...
    private void zzv(boolean z) {
        zzin.m33v("AdMediaPlayerView release");
        if (this.zzDR != null) {
            this.zzDR.reset();
            this.zzDR.release();
            this.zzDR = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzin.m33v("AdMediaPlayerView completion");
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C02072(this));
    }
    ...
    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        ...
        zzin.m33v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzin.m33v("AdMediaPlayerView prepared");
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C02061(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzin.m33v("AdMediaPlayerView surface created");
        zzfa();
        zzir.zzMc.post(new C02094(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzin.m33v("AdMediaPlayerView surface destroyed");
        if (this.zzDR != null && this.zzEb == 0) {
            this.zzEb = this.zzDR.getCurrentPosition();
        }
        zzir.zzMc.post(new C02105(this));
        zzv(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzin.m33v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzin.m33v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzin.m33v("AdMediaPlayerView pause");
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C02127(this));
        }
        zzx(4);
    }

    public void play() {
        zzin.m33v("AdMediaPlayerView play");
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C02116(this));
        }
        zzx(3);
    }

    public void seekTo(int millis) {
        zzin.m33v("AdMediaPlayerView seek " + millis);
        if (zzfe()) {
    ...
    public void stop() {
        zzin.m33v("AdMediaPlayerView stop");
        if (this.zzDR != null) {
            this.zzDR.stop();
            this.zzDR.release();
            this.zzDR = null;
