...
public class zzfp extends zzfs {
    ...
    class C03932 implements OnClickListener {
        ...
        C03932(zzfp com_google_android_gms_internal_zzfp) {
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0196R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0196R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0196R.string.accept, "Accept"), new OnClickListener(this) {
                        final /* synthetic */ zzfp zzDt;
                    ...
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0196R.string.decline, "Decline"), new C03932(this));
                    zzL.create().show();
                    return;
                }
