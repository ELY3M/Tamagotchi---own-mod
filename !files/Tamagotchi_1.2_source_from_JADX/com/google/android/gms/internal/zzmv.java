        ...
        synchronized (zzmv.class) {
            if (SystemClock.elapsedRealtime() - zzaoc >= 60000 || zzaod == Float.NaN) {
                ...
                if (registerReceiver != null) {
                    zzaod = ((float) registerReceiver.getIntExtra(LevelConstants.TAG_LEVEL, -1)) / ((float) registerReceiver.getIntExtra(ISVGConstants.ATTRIBUTE_TRANSFORM_VALUE_SCALE, -1));
                }
