...
public class zzeg {
    ...
    public static class zzd extends zzjj<zzeh> {
        ...
        class C07861 implements com.google.android.gms.internal.zzji.zzc<zzeh> {
            final /* synthetic */ zzd zzBq;

            C07861(zzd com_google_android_gms_internal_zzeg_zzd) {
                this.zzBq = com_google_android_gms_internal_zzeg_zzd;
            }

            public void zzd(zzeh com_google_android_gms_internal_zzeh) {
                zzin.m33v("Ending javascript session.");
        ...
        class C07872 implements com.google.android.gms.internal.zzji.zzc<zzeh> {
            final /* synthetic */ zzd zzBq;

            C07872(zzd com_google_android_gms_internal_zzeg_zzd) {
                this.zzBq = com_google_android_gms_internal_zzeg_zzd;
            }

            public void zzd(zzeh com_google_android_gms_internal_zzeh) {
                zzin.m33v("Releasing engine reference.");
                this.zzBq.zzBo.zzet();
            }
        ...
        class C07883 implements com.google.android.gms.internal.zzji.zza {
            final /* synthetic */ zzd zzBq;

            C07883(zzd com_google_android_gms_internal_zzeg_zzd) {
                this.zzBq = com_google_android_gms_internal_zzeg_zzd;
            }
        ...
        public void release() {
            synchronized (this.zzpV) {
                ...
                this.zzBp = true;
                zza(new C07861(this), new com.google.android.gms.internal.zzji.zzb());
                zza(new C07872(this), new C07883(this));
            }
        }
    }
    ...
    public static class zze extends zzjj<zzed> {
        ...
        class C07913 implements com.google.android.gms.internal.zzji.zzc<zzed> {
            final /* synthetic */ zze zzBu;

            C07913(zze com_google_android_gms_internal_zzeg_zze) {
            ...
            synchronized (this.zzpV) {
                zza(new com.google.android.gms.internal.zzji.zzc<zzed>(this) {
                    ...
                    public void zza(zzed com_google_android_gms_internal_zzed) {
                        zzin.m33v("Getting a new session for JS Engine.");
                    ...
                    public void run() {
                        zzin.m33v("Rejecting reference for JS Engine.");
        ...
        protected void zzet() {
            ...
            synchronized (this.zzpV) {
                ...
                zzx.zzab(z);
                zzin.m33v("Releasing 1 reference for JS Engine");
                this.zzBs--;
                zzev();
            }
        }
        ...
        public void zzeu() {
            ...
            synchronized (this.zzpV) {
                ...
                zzx.zzab(z);
                zzin.m33v("Releasing root reference. JS Engine will be destroyed once other references are released.");
                this.zzBr = true;
                zzev();
            }
        }
        ...
        protected void zzev() {
            synchronized (this.zzpV) {
                ...
                if (this.zzBr && this.zzBs == 0) {
                    zzin.m33v("No reference is left (including root). Cleaning up engine.");
                    zza(new C07913(this), new com.google.android.gms.internal.zzji.zzb());
                } else {
                    zzin.m33v("There are still references to the engine. Not destroying.");
                }
            }
        }
    }
        ...
        zzir.runOnUiThread(new Runnable(this) {
            ...
            public void run() {
                ...
                zza.zza(new com.google.android.gms.internal.zzed.zza(this) {
                    final /* synthetic */ C03731 zzBg;

                    class C03701 implements Runnable {
                        final /* synthetic */ C07811 zzBh;

                        class C03691 implements Runnable {
                            final /* synthetic */ C03701 zzBi;

                            C03691(C03701 c03701) {
                                this.zzBi = c03701;
                            }
                        ...
                        L_0x0027:
                            ...
                            com.google.android.gms.internal.zzin.m33v(r0);	 Catch:{ all -> 0x003f }
                            monitor-exit(r1);	 Catch:{ all -> 0x003f }
                            goto L_0x0026;
                        L_0x003f:
                            r0 = move-exception;
                    ...
                    public void zzeo() {
                        zzir.zzMc.postDelayed(new C03701(this), (long) zza.zzBn);
                    }
                });
                zza.zza("/jsLoaded", new zzdf(this) {
                    ...
                    L_0x0021:
                        ...
                        com.google.android.gms.internal.zzin.m33v(r0);	 Catch:{ all -> 0x0051 }
                        monitor-exit(r1);	 Catch:{ all -> 0x0051 }
                        goto L_0x0020;
                    L_0x0051:
                        r0 = move-exception;
                ...
                com_google_android_gms_internal_zzja.set(c07833);
                zza.zza("/requestReload", c07833);
                ...
                zzir.zzMc.postDelayed(new Runnable(this) {
                    ...
                    class C03711 implements Runnable {
                        final /* synthetic */ C03724 zzBk;

                        C03711(C03724 c03724) {
                            this.zzBk = c03724;
                        }
                    ...
                    L_0x0021:
                        ...
                        r0 = "Could not receive loaded message in a timely manner. Rejecting.";
                        com.google.android.gms.internal.zzin.m33v(r0);	 Catch:{ all -> 0x0037 }
                        monitor-exit(r1);	 Catch:{ all -> 0x0037 }
                        goto L_0x0020;
                    L_0x0037:
                        r0 = move-exception;
    ...
    protected zze zzeq() {
        ...
        zzep.zza(new com.google.android.gms.internal.zzji.zzc<zzed>(this) {
            ...
            public void zza(zzed com_google_android_gms_internal_zzed) {
                synchronized (this.zzBe.zzpV) {
                    ...
                    if (!(this.zzBe.zzBb == null || zzep == this.zzBe.zzBb)) {
                        zzin.m33v("New JS engine is loaded, marking previous one as destroyable.");
                        this.zzBe.zzBb.zzeu();
                    }
                    this.zzBe.zzBb = zzep;
                }
            ...
            public void run() {
                synchronized (this.zzBe.zzpV) {
                    this.zzBe.zzBc = 1;
                    zzin.m33v("Failed loading new engine. Marking new engine destroyable.");
                    zzep.zzeu();
                }
            }
        });
