    ...
    public static final class zza {
        ...
        private void zzC(Context context) {
            ...
            if (registerReceiver != null) {
                ...
                this.zzKh = (double) (((float) registerReceiver.getIntExtra(LevelConstants.TAG_LEVEL, -1)) / ((float) registerReceiver.getIntExtra(ISVGConstants.ATTRIBUTE_TRANSFORM_VALUE_SCALE, -1)));
