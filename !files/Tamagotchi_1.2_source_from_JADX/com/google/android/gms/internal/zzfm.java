...
public class zzfm extends zzfs {
    ...
    class C03891 implements OnClickListener {
        ...
        C03891(zzfm com_google_android_gms_internal_zzfm) {
    ...
    class C03902 implements OnClickListener {
        ...
        C03902(zzfm com_google_android_gms_internal_zzfm) {
            this.zzCZ = com_google_android_gms_internal_zzfm;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzL.setTitle(zzr.zzbF().zzd(C0196R.string.create_calendar_title, "Create calendar event"));
            zzL.setMessage(zzr.zzbF().zzd(C0196R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzL.setPositiveButton(zzr.zzbF().zzd(C0196R.string.accept, "Accept"), new C03891(this));
            zzL.setNegativeButton(zzr.zzbF().zzd(C0196R.string.decline, "Decline"), new C03902(this));
            zzL.create().show();
        } else {
