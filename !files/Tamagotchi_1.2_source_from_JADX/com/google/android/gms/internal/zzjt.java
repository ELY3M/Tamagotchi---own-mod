...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class C04291 implements Runnable {
        ...
        C04291(zzjt com_google_android_gms_internal_zzjt) {
    ...
    public void destroy() {
        synchronized (this.zzpV) {
            ...
            zzit();
            this.zzNT = true;
            zzin.m33v("Initiating WebView self destruct sequence in 3...");
            this.zzNQ.zzii();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzin.m33v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhZ() {
        synchronized (this.zzpV) {
            zzin.m33v("Destroying WebView!");
            zzir.zzMc.post(new C04291(this));
        }
    }
