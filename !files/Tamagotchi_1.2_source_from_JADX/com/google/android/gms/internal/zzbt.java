...
public final class zzbt {
    ...
    public static final zzbp<Integer> zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) StatusCodes.AUTH_DISABLED);
    ...
    public static final zzbp<Long> zzwM = zzbp.zza(0, "gads:device_info_caching_expiry_ms:expiry", (long) MainGame.UPDATE_INTERVAL_IN_MILLISECONDS);
