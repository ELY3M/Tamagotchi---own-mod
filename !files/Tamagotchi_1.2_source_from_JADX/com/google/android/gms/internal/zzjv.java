...
public class zzjv extends WebChromeClient {
    ...
    private static void zza(Builder builder, String str, final JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(ACRAConstants.DEFAULT_DIALOG_POSITIVE_BUTTON_TEXT, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                jsResult.confirm();
            }
        }).setNegativeButton(ACRAConstants.DEFAULT_DIALOG_NEGATIVE_BUTTON_TEXT, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                jsResult.cancel();
            }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, final JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(ACRAConstants.DEFAULT_DIALOG_POSITIVE_BUTTON_TEXT, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C04367.zzOk[consoleMessage.messageLevel().ordinal()]) {
            case 1:
                zzb.m9e(str);
                break;
            case 2:
