...
public class zzir {
    ...
    public boolean zzI(Context context) {
        ...
        if ((resolveActivity.activityInfo.configChanges & 128) == 0) {
            zzb.zzaK(String.format(str, new Object[]{TMXConstants.TAG_MAP_ATTRIBUTE_ORIENTATION}));
            z = false;
        }
                ...
                if (!adSizeParcel.zzui) {
                    ...
                    while (view != null) {
                        ...
                        if (parent != null) {
                            ...
                            jSONObject3.put(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE, parent.getClass().getName());
