...
class zzcn implements zzf {
    ...
    class C05121 implements Runnable {
        ...
        C05121(zzcn com_google_android_gms_tagmanager_zzcn) {
    ...
    public void zzGl() {
        this.zzbkn.execute(new C05121(this));
    }
    ...
    public void zzb(final zza com_google_android_gms_internal_zzrq_zza) {
        this.zzbkn.execute(new Runnable(this) {
            final /* synthetic */ zzcn zzbko;

            public void run() {
                this.zzbko.zzc(com_google_android_gms_internal_zzrq_zza);
            }
        });
    }
