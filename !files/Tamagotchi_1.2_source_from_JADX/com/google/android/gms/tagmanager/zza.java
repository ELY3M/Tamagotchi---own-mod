...
public class zza {
    ...
    class C05082 implements Runnable {
        ...
        C05082(zza com_google_android_gms_tagmanager_zza) {
    ...
    class C08551 implements zza {
        final /* synthetic */ zza zzbhB;

        C08551(zza com_google_android_gms_tagmanager_zza) {
            this.zzbhB = com_google_android_gms_tagmanager_zza;
        }
    ...
    public zza(Context context, zza com_google_android_gms_tagmanager_zza_zza, zzmq com_google_android_gms_internal_zzmq) {
        ...
        this.zzLM = new Thread(new C05082(this));
    }
