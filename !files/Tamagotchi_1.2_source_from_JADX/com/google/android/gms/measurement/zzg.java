...
public final class zzg {
    ...
    private final List<zzh> zzaUw = new CopyOnWriteArrayList();
    private final zzb zzaUx = new zzb();
    private final zza zzaUy = new zza(this);
    ...
    void zze(zzc com_google_android_gms_measurement_zzc) {
        if (com_google_android_gms_measurement_zzc.zzAD()) {
            ...
            final zzc zzAu = com_google_android_gms_measurement_zzc.zzAu();
            zzAu.zzAA();
            this.zzaUy.execute(new Runnable(this) {
                final /* synthetic */ zzg zzaUB;
