...
public class zzad extends zzz {
    ...
    private long zzaZa;
    private final Runnable zzaZb = new C04751(this);
    ...
    class C04751 implements Runnable {
        ...
        C04751(zzad com_google_android_gms_measurement_internal_zzad) {
            this.zzaZe = com_google_android_gms_measurement_internal_zzad;
        }

        @MainThread
        public void run() {
            this.zzaZe.zzCn().zzg(new C04741(this));
        }
    }
