...
class zze extends zzz {
    ...
    private boolean zza(String str, int i, com.google.android.gms.internal.zzpz.zzb com_google_android_gms_internal_zzpz_zzb) {
        ...
        try {
            ...
            contentValues.put(TMXConstants.TAG_DATA, bArr);
            try {
    ...
    public zzai zzK(String str, String str2) {
        ...
        zzjv();
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"set_timestamp", TMXConstants.TAG_PROPERTY_ATTRIBUTE_VALUE}, "app_id=? and name=?", new String[]{str, str2}, null, null, null);
            try {
                if (query.moveToFirst()) {
    ...
    Map<Integer, List<com.google.android.gms.internal.zzpz.zzb>> zzL(String str, String str2) {
        ...
        try {
            query = getWritableDatabase().query("event_filters", new String[]{"audience_id", TMXConstants.TAG_DATA}, "app_id=? AND event_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
    ...
    Map<Integer, List<com.google.android.gms.internal.zzpz.zze>> zzM(String str, String str2) {
        ...
        Cursor query;
        try {
            query = getWritableDatabase().query("property_filters", new String[]{"audience_id", TMXConstants.TAG_DATA}, "app_id=? AND property_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
                    zzsm zzD = zzsm.zzD(query.getBlob(1));
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    try {
                        ...
                        cursor2 = writableDatabase.query("raw_events", new String[]{"rowid", "name", "timestamp", TMXConstants.TAG_DATA}, "app_id=? and metadata_fingerprint=?", new String[]{string, str2}, null, null, "rowid", null);
                        if (cursor2.moveToFirst()) {
                            do {
                                try {
    ...
    public boolean zza(zzai com_google_android_gms_measurement_internal_zzai) {
        ...
        zza(contentValues, TMXConstants.TAG_PROPERTY_ATTRIBUTE_VALUE, com_google_android_gms_measurement_internal_zzai.zzNc);
        try {
    ...
    public List<zzai> zzeX(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", "set_timestamp", TMXConstants.TAG_PROPERTY_ATTRIBUTE_VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzCp().zzBM()));
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    public List<Pair<com.google.android.gms.internal.zzqb.zze, Long>> zzn(String str, int i, int i2) {
        ...
        zzx.zzcM(str);
        try {
            query = getWritableDatabase().query("queue", new String[]{"rowid", TMXConstants.TAG_DATA}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(i));
            try {
                if (query.moveToFirst()) {
