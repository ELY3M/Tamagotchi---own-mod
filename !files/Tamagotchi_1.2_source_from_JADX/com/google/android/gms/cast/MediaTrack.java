...
public final class MediaTrack {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            switch (this.zzabB) {
                case 1:
                    jSONObject.put(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE, "TEXT");
                    break;
                case 2:
                    jSONObject.put(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE, "AUDIO");
                    break;
                case 3:
                    jSONObject.put(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE, "VIDEO");
                    break;
            }
            if (this.zzaaN != null) {
