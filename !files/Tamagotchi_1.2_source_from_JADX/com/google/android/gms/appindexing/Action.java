...
public final class Action extends Thing {
    ...
    public static final class Builder extends com.google.android.gms.appindexing.Thing.Builder {
        public Builder(String actionType) {
            zzx.zzz(actionType);
            super.put(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE, actionType);
        }

        public Action build() {
            zzx.zzb(this.zzUH.get(TMXConstants.TAG_OBJECT), (Object) "setObject is required before calling build().");
            zzx.zzb(this.zzUH.get(TMXConstants.TAG_OBJECT_ATTRIBUTE_TYPE), (Object) "setType is required before calling build().");
            Bundle bundle = (Bundle) this.zzUH.getParcelable(TMXConstants.TAG_OBJECT);
        ...
        public Builder setObject(Thing thing) {
            zzx.zzz(thing);
            return (Builder) super.put(TMXConstants.TAG_OBJECT, thing);
        }
