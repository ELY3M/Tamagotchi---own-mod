...
public final class PSA {
    ...
    public static AzimuthZenithAngle calculateSolarPosition(GregorianCalendar date, double latitude, double longitude) {
        ...
        double dDecimalHours = ((double) utcTime.get(11)) + ((((double) utcTime.get(12)) + (((double) utcTime.get(13)) / 60.0d)) / 60.0d);
        long liAux1 = (long) (((utcTime.get(2) + 1) - 14) / 12);
        double dElapsedJulianDays = ((((double) ((((((1461 * (((long) (utcTime.get(1) + 4800)) + liAux1)) / 4) + ((367 * (((long) ((utcTime.get(2) + 1) - 2)) - (12 * liAux1))) / 12)) - ((3 * ((((long) (utcTime.get(1) + 4900)) + liAux1) / 100)) / 4)) + ((long) utcTime.get(5))) - 32075)) - 0.5d) + (dDecimalHours / 24.0d)) - 2451545.0d;
        double dOmega = 2.1429d - (0.0010394594d * dElapsedJulianDays);
        double dMeanAnomaly = 6.24006d + (0.0172019699d * dElapsedJulianDays);
        double dEclipticLongitude = ((((0.03341607d * Math.sin(dMeanAnomaly)) + (4.895063d + (0.017202791698d * dElapsedJulianDays))) + (3.4894E-4d * Math.sin(2.0d * dMeanAnomaly))) - 1.134E-4d) - (2.03E-5d * Math.sin(dOmega));
