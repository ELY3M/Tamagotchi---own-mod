...
public final class CrashReportPersister {
    ...
    public CrashReportData load(@NonNull File file) throws IOException {
        ...
        try {
            CrashReportData load = load(new InputStreamReader(new BufferedInputStream(in, 8192), "ISO8859-1"));
            return load;
        } finally {
            in.close();
        }
    ...
    public void store(@NonNull CrashReportData crashData, @NonNull File file) throws IOException {
        ...
        try {
            ...
            OutputStreamWriter writer2 = new OutputStreamWriter(new FileOutputStream(file), "ISO8859_1");
            try {
    ...
    private synchronized org.acra.collector.CrashReportData load(@android.support.annotation.NonNull java.io.Reader r22) throws java.io.IOException {
        /*
        r21 = this;
        monitor-enter(r21);
        r11 = 0;
    ...
    L_0x01d1:
        org.acra.collector.CollectorUtil.safeClose(r22);	 Catch:{ all -> 0x003d }
        monitor-exit(r21);
        return r5;
        */
