...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0144R.attr.homeAsUpIndicator});
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (a.hasValue(C0144R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0144R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0144R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR);
            }
            if (a.getBoolean(C0144R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY);
            }
            if (a.getBoolean(C0144R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0144R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            return;
        }
        a.recycle();
