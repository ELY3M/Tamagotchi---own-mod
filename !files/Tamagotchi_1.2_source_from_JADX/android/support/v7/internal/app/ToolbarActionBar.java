...
public class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C06362();
    private final Runnable mMenuInvalidator = new C01451();
    ...
    class C06362 implements OnMenuItemClickListener {
        C06362() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0144R.layout.abc_list_menu_item_layout);
