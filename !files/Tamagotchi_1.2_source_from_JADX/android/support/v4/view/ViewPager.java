...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00911();
    ...
    private static final Interpolator sInterpolator = new C00922();
    ...
    private final Runnable mEndScrollRunnable = new C00933();
    ...
    static class C00911 implements Comparator<ItemInfo> {
        C00911() {
        }
    ...
    static class C00922 implements Interpolator {
        C00922() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C06271());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C06271 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06271() {
            }
    ...
    class C06264 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06264());
    }
